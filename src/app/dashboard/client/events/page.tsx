                ...
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {events.map((event) => {
                        ...
                        return (
                            <div
                                key={event.id}
                                className="group relative overflow-hidden rounded-2xl shadow-sm bg-white border hover:shadow-lg transition-all duration-300"
                            >
                                <div className="absolute top-4 right-4 z-10">
                                    <span
                                        className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ${isUpcoming
